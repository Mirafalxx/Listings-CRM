...
export class BrandConditionComponent implements OnInit {
  ...
  myForm: FormGroup;
  constructor(private http: HttpClient, private _snackBar: MatSnackBar, private listingServices: ListingService, public dialog: MatDialog) { }
  condition: Condition[] = [
  ...
  getBannedBrand = () => {
    this.listingServices.getBannedBrand().subscribe((data2: any) => {
